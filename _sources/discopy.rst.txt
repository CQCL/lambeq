...
Thus, it is not a surprise that advanced use of ``lambeq``, involving extending the toolkit with new :term:`compositional models <compositional model>` and :term:`ansätze <ansatz>`, requires some familiarity of DisCoPy. For this, you can use the following resources:
