...
def tree():
    n, s = Ty('n'), Ty('s')
    the = CCGTree(text='the', categorial_type=n << n)
    do = CCGTree(text='do', categorial_type=s >> s)
    do_unary = CCGTree(text='do', rule='U', categorial_type=n, children=(do,))
    return CCGTree(text='the do', rule='FA', categorial_type=n, children=(the, do_unary))
...
def test_child_reqs(tree):
    with pytest.raises(ValueError):
        CCGTree(rule='U', categorial_type=tree.categorial_type, children=tree.children)
