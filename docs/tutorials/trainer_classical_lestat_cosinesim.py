...
train_labels, train_data = read_data('../examples/datasets/lestat_small_train_data.txt')
val_labels, val_data = read_data('../examples/datasets/lestat_small_train_data.txt')
test_labels, test_data = read_data('../examples/datasets/lestat_small_train_data.txt')
...
val_diagrams = [spiders_reader.sentence2diagram(sent) for sent in train_data]
test_diagrams = [spiders_reader.sentence2diagram(sent) for sent in train_data]
...
input_data=(train_circuits,val_circuits)
