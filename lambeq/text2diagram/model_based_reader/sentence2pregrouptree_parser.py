...
from lambeq.sentence2pregrouptree import (BertForSentenceToTree,
                                          SentenceToTreeBertConfig)
from lambeq.sentence2pregrouptree.bert import ROOT_TOKEN
...
class SentenceToPregroupTreeParser(Reader):
    def __init__(
        self,
